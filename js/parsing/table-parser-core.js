(function (root, factory) {
    ...
    const HEADER_ALIASES = {
        ...
        availabilityRaw: ['availability', 'slot status', 'slot availability', 'capacity', 'local status', '名額', '名額狀態', '收案名額', '院內名額'],
        cancerType: ['cancer type', 'tumor type', 'indication', 'disease', '癌別', '疾病別'],
        treatmentLines: ['line', 'treatment line', 'therapy line', '線別', '治療線別'],
        interventions: ['intervention', 'interventions', 'drug', 'drugs', 'regimen', '治療', '藥物', '試驗藥物'],
        pi: ['pi', 'principal investigator', 'investigator', '主持人', '計畫主持人', '試驗主持人'],
        nurse: ['study nurse', 'research nurse', 'coordinator', 'crc', 'sc', '研究護理師', '個管師', '研究協調員'],
        phone: ['phone', 'contact phone', 'telephone', '聯絡電話', '電話'],
        email: ['email', 'e-mail', 'contact email', '電子郵件', '信箱'],
